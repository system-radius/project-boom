...
public class PlayerConfigView extends GamePanel implements ButtonPressListener {
    ...
    private final BotLevel[] botLevels = new BotLevel[]{
            BotLevel.A_CLASS, BotLevel.B_CLASS, BotLevel.C_CLASS, BotLevel.D_CLASS, BotLevel.E_CLASS,
            BotLevel.S_CLASS
    };
    ...
    private final Color[] botColors = new Color[] {
            new Color(0x101040ff), new Color(0x401040ff), new Color(0x404010ff),
            new Color(0x104010ff), new Color(0x8b4513ff),
            Color.GOLD
    };
